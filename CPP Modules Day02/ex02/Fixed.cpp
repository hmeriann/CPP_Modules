...
//comparison operators
	...
	Fixed	Fixed::operator+(const Fixed &rhs)
	{
		...
		std::cout << BLUE  << "+ operator called for values " << RESET << this->getRawBits() <<
	...
	{
		std::cout << MAGENTA <<"post-increment operator called for value "<< RESET << this->getRawBits() << std::endl;
	...
	Fixed	&Fixed::operator--()
	{
		std::cout << MAGENTA <<"post-decrement operator called for value "<< RESET << std::endl;
		this->fixedPointNumber--;
	...
	{
		std::cout << MAGENTA <<"pre-increment operator called for value " << RESET<< std::endl;
		Fixed	tmp(*this);
		operator++();
		return tmp;
	}
	...
	Fixed	Fixed::operator--(int)
	{
		std::cout << MAGENTA <<"pre-decrement operator called for value " << RESET<< std::endl;
		Fixed	tmp(*this);
		operator--();
		return tmp;
	}
